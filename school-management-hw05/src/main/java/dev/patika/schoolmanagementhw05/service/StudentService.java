...
import dev.patika.schoolmanagementhw05.exceptions.StudentAgeNotValidException;
import dev.patika.schoolmanagementhw05.mappers.StudentMapper;
...
public class StudentService {
    ...
    public List<Student> findAllStudentsByStudentId(List<Long> studentIds) {
        ...
        for (Long studentId : studentIds) {
            studentList.add(findStudentById(studentId));
        }
        return studentList;
    }
}