...
@JsonSubTypes({@JsonSubTypes.Type(value = PermanentInstructor.class, name = "Permanent"),
        @JsonSubTypes.Type(value = VisitingResearcher.class, name = "Visiting")}) // Instructor type should be declared
